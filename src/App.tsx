...
const navConfig: Record<UserRole, { label: string; items: { icon: string; label: string; section: string; badge?: number }[] }[]> = {
  ...
  hr_manager: [
    {
      ...
      items: [
        ...
        { icon: '⚖️', label: 'Leave Balances', section: 'balances' },
      ],
    },
  ],
  payroll_officer: [
  ...
  supervisor: [
    ...
    },
    {
      label: 'Self-Service',
      items: [
        { icon: '👤', label: 'My Info', section: 'myinfo' },
        { icon: '🔔', label: 'Notifications', section: 'notifications' },
      ],
    },
  ],
...
const pageTitles: Record<string, string> = {
  ...
  payslips: 'Payslips', profile: 'My Profile', balances: 'Leave Balances',
  myinfo: 'My Info', notifications: 'Notifications',
}
