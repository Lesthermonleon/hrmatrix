...
const navConfig: Record<UserRole, { label: string; items: { icon: string; label: string; section: string; badge?: number }[] }[]> = {
  ...
  hr_manager: [
    {
      ...
      items: [
        ...
        { icon: '🏖️', label: 'Leave Balances', section: 'leave_balances' },
      ],
    },
    {
      label: 'Alerts',
  ...
  supervisor: [
    ...
    },
    {
      label: 'Self Service',
      items: [
        { icon: '🕒', label: 'My Attendance', section: 'my_attendance' },
        { icon: '📝', label: 'File My Leave', section: 'my_leave' },
      ],
    },
    {
      label: 'Alerts',
...
const pageTitles: Record<string, string> = {
  ...
  payslips: 'Payslips', profile: 'My Profile', notifications: 'Notifications',
  leave_balances: 'Leave Balances', my_attendance: 'My Attendance', my_leave: 'File My Leave',
}
